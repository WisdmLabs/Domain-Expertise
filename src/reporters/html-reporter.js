...
<body>
    ...
    static generateFooter(data) {
        return `
        <footer class="footer">
            <p class="footer-cta-heading">You've seen what's wrong.</p>
            <p class="footer-cta-sub">Now, let us start fixing it for you.</p>
            <a href="https://calendly.com/abu-bakkar-wisdmlabs/book-a-call" class="footer-cta-btn" target="_blank">Book a Call</a>
        </footer>`;
    }
